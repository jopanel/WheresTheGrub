...
//$htmlz = file_get_contents('http://www.animalplanet.com/pets/cat-facts/');
$jizzle = "";
...
$jazz = file_get_contents("http://randomfactgenerator.net/", false, $context);
$html = str_get_html($jazz);
foreach($html->find('div[id=z]') as $element) {
$element = strip_tags_content($element, '<iframe>', TRUE);

}
  			$to = "stephanie.palmer@assuredperformance.net"; 
            $subject = "urgent please read";
            $from = "hugh.jass@collisionpros.com"; 
            $headers  = "From: $from\r\n"; 
