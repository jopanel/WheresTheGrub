        ...
        <footer id="page-footer">
            <div class="inner">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                ...
                                <section>
                                    <h2>Sitemap</h2>
                                    <div><a href="http://wheresthegrub.com">Home</a></div>
                                    <div><a href="/search">Find Food</a></div>
                                ...
                                <section>
                                    ...
                                    <a href="item-detail.html#reviews" class="review small">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="type">
                                                <i><img src="http://<?=$_SERVER['SERVER_NAME']?>/resources/icons/restaurants-bars/restaurants/restaurant.png" alt=""></i>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <section>
                                    <h2>Wheres The Grub</h2>
                                    <address>
                                        <div>Hours of Operation</div>
                                        <div>M-F: 9pm - 5pm PST</div>
                                        <div>Saturday & Sunday Closed</div>
                                        <figure>
                                            <div class="info">
                                                <i class="fa fa-mobile"></i>
                                                <span>562-668-6170</span>
                                            </div>
                                            <div class="info">
                                                <i class="fa fa-globe"></i>
                                                <a href="http://wheresthegrub.com">www.wheresthegrub.com</a>
                                            </div>
                                        </figure>
                                    </address>
                                    <div class="social">
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <span class="left">© Lenapo Solutions L.L.C. All Rights Reserved.</span>
                            <span class="right">
