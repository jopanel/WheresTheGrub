                    ...
                    <div class="row"> 
                        ...
                        */
                        ...
                        <?php } else { ?>
                            <header>
                                <ul class="nav nav-pills">
                                    <li class="active"><a href="http://<?=$_SERVER["SERVER_NAME"]?>/vendor/reports/<?=$rid?>/"><h1 class="page-title">Overview</h1></a></li>
                                    <li><a href="http://<?=$_SERVER["SERVER_NAME"]?>/vendor/reports/<?=$rid?>/followers"><h1 class="page-title">Followers</h1></a></li>
                                    <li><a href="http://<?=$_SERVER["SERVER_NAME"]?>/vendor/reports/<?=$rid?>/reviews"><h1 class="page-title">Reviews</h1></a></li>
                                    <li><a href="http://<?=$_SERVER["SERVER_NAME"]?>/vendor/reports/<?=$rid?>/desktop"><h1 class="page-title">Desktop</h1></a></li>
                                    <li><a href="http://<?=$_SERVER["SERVER_NAME"]?>/vendor/reports/<?=$rid?>/mobile"><h1 class="page-title">Mobile</h1></a></li>
                                    <li><a href="http://<?=$_SERVER["SERVER_NAME"]?>/vendor/reports/<?=$rid?>/adwords"><h1 class="page-title">Adwords</h1></a></li>
                                </ul>
                            </header> 
                            <header>
