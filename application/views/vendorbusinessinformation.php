<div id="page-content">
                <section class="container">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-9 col-sm-9">
                                            ...
                                            <header>
                                                <ul class="nav nav-pills">
                                                    <li class="active"><a href="<?=base_url()?>vendor/businessinformation/<?=$rid?>/"><h1 class="page-title">Manage Information</h1></a></li>
            ...
            function saveChanges(rid) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?=base_url()?>vendor/updateBasicInfo/'+rid+'/basic',
                    data: apiData,
                    cache: false,
